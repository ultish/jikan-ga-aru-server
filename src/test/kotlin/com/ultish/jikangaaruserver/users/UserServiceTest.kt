...
@SpringBootTest(
   classes = [
      // Note: this would start up the whole application (can be expensive). Couldn't use DgsAutoConfiguration as it
      // wouldn't load my customContext. There should be a way to rig DgsAutoConfiguration with my CustomContext to
      // make this faster. https://github.com/Netflix/dgs-framework/blob/65933df1f26711f7f58c0e1bd1d9885aac1d8dbb
      // /graphql-dgs-spring-boot-oss-autoconfigure/src/test/kotlin/com/netflix/graphql/dgs/autoconfig/testcomponents
      // /MyCustomDgsContextBuilder.kt may be an example
